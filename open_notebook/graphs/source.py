...
async def save_source(state: SourceState) -> dict:
    ...
    # Automatically apply default transformations
    default_transformations = await Transformation.get_by_attribute("apply_default", True)
    if default_transformations:
        state["apply_transformations"].extend(default_transformations)
